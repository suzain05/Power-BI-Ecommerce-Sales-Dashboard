...
Dataset: Kaggle Ecommerce sales dataset (191 order rows, 13 columns including Order ID, Order Date, Customer Name, Category, Payment Mode, Ship Mode, State, City, Quantity, Sales, Profit) Time Period: January – December 2023 Granularity: One row per order transaction
